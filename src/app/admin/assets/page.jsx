        ...
        <div className="p-6 space-y-6">
                    ...
                    {!selectedProduct && (
                        <>
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 text-indigo-700 rounded-lg hover:bg-indigo-50 transition-all font-medium shadow-sm"
                            >
                                <Package size={18} />
                                Add to Vault
                            </button>
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-all font-medium shadow-sm hover:shadow-emerald-200"
                            >
                                <Share size={18} />
                                Checkout Asset
                            </button>
            ...
            {!selectedProduct ? (
                ...
                <div className="space-y-6">
                    {loading ? (
                        <div className="text-center p-12 text-slate-500 bg-white rounded-xl border border-slate-200 shadow-sm flex justify-center items-center gap-3">
                            <div className="w-5 h-5 border-2 border-indigo-600 border-t-transparent rounded-full animate-spin"></div>
                            Loading vault inventory...
                        </div>
                    ) : vaultStats.length === 0 ? (
                        <div className="text-center p-12 text-slate-500 bg-white rounded-xl border border-slate-200 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {vaultStats.map((stat) => (
                                <div 
                                    ...
                                    className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md hover:border-indigo-300 transition-all cursor-pointer group relative overflow-hidden"
                                >
                                    {stat.available === 0 && (
                    ...
                    <div className="p-4 border-b border-slate-200 flex flex-col sm:flex-row items-center gap-4 bg-slate-50/50">
                        <div className="relative flex-1 w-full max-w-md">
                            ...
                            <input 
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 outline-none shadow-sm" 
                            />
                        </div>
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                            ...
                            <select
                                ...
                                className="bg-white px-3 py-2 rounded-lg border border-slate-300 font-medium text-slate-700 outline-none cursor-pointer focus:ring-2 focus:ring-indigo-100 shadow-sm"
                            >
