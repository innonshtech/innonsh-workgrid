...
export default function SocialFeed() {
    ...
    return (
        <div className="p-4 md:p-6 max-w-4xl mx-auto space-y-6">
            ...
            {/* Create Post Area */}
            <form onSubmit={handlePostSubmit} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                    ...
                    <button
                        ...
                        className="bg-indigo-600 text-white px-6 py-2 rounded-xl font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 disabled:opacity-50 transition-all flex items-center gap-2"
                    >
